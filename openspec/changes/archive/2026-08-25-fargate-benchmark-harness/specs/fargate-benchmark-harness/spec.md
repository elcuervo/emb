...
## Purpose
Specifies the Fargate-shaped benchmark harness used to establish and compare performance baselines on `linux/arm64` (Graviton) so that performance proposals can be validated against the deployment target.
