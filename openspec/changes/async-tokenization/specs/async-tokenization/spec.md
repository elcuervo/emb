...
## Purpose
Specifies dedicated tokenizer workers that overlap tokenization with inference behind a bounded queue, keeping the session busy and the request ordering stable.
