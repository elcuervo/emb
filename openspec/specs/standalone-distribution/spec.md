...
Specifies the standalone platform tarballs published as GitHub Release assets, the unified naming convention, the install script, and macOS binary linking requirements.
