...
Specifies a single `just all` recipe that runs the complete project test suite including Go server tests, Ruby gem RSpec suite, and emb-server gem build validation.
