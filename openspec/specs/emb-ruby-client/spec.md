...
Specifies the Ruby client gem (`emb`) that provides a Redis-based interface to the emb server with proxy-based API, command wrappers, multi-model batching, and connection pooling.
