...
Specifies the CI validation tooling for both Ruby gems, including local gem validation via `just validate-gems`, `act` for local CI testing, aligned CI triggers, and a standalone CI workflow for `emb-server`.
